...
mod wav_override_tests {
    ...
    fn le_repli_de_stop_epargne_les_sorties_des_autres_zones() {
        ...
        let revendiquees = Orchestrator::sorties_revendiquees_par_les_autres_zones(zones, 15);
        ...
        let a_arreter = Orchestrator::sorties_a_arreter_en_repli(&enregistrees, &revendiquees);
    ...
    fn le_repli_peut_toujours_fermer_la_sortie_de_la_zone_qui_arrete() {
        ...
        let revendiquees = Orchestrator::sorties_revendiquees_par_les_autres_zones(zones, 10);
        assert!(
