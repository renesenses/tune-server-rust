...
impl PlaybackOrchestrator {
    ...
    pub(super) fn load_streaming_dsp(
        ...
        StreamingDsp {
            ...
            // #2742 — le crossfeed rejoint les trois autres.
            // `load_crossfeed_processor` n'a jamais porté de garde `local:` :
            // la contrainte vivait chez ses APPELANTS, tous dans la sortie
            // locale. Un bras progressif est donc libre de le charger, et
            // c'est ce qui lui ouvre les zones réseau. La ligne à retard est
            // bâtie au taux réellement servi, comme les biquads juste au-dessus.
