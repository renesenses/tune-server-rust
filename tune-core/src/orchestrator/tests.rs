...
/// `is_active()`.
///
/// Sans la première assertion, une zone réseau qui n'a QUE du crossfeed
...
/// témoin injecte du L ≠ R : un test sur `pcm_sinus_16`, qui écrit le même
/// échantillon dans les deux canaux, passerait au vert sans rien prouver.
#[test]
